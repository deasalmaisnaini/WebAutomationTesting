...
public class LoginSteps {
	...
	public void the_label_and_border_in_the_field_are_red(String field) {
		...
		if (field.equals("both")) {
			isLabelBorderRed = objLogin.isErrorFieldUsername() && objLogin.isUsernamePlaceholderRed()
					&& objLogin.isErrorFieldPassword() && objLogin.isPasswordPlaceholderRed();
		} else if (field.equals("username")) {
			isLabelBorderRed = objLogin.isErrorFieldUsername() && objLogin.isUsernamePlaceholderRed();
		} else if (field.equals("password")) {
			isLabelBorderRed = objLogin.isErrorFieldPassword() && objLogin.isPasswordPlaceholderRed();
		}

		Assert.assertTrue(isLabelBorderRed);
	}
